                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                <i class="bi bi-door-open">Register</i></a>
                        @endif
                    @endauth
                </div>
            @endif
            <main class="container-fluid">
                <div class="row g-0 full-height">
                    <div class="col-md-6 d-flex justify-content-center align-items-center">
                        <div class="image-section w-100 h-100">
                            <img src="{{ asset('assets/img/background.jpg') }}" alt="collection of books" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-md-6 d-flex flex-column justify-content-center p-5">
                        <h1 style="color: red; text-align: center;"><strong>ONLINE BOOKSTORE</strong></h1>
                        <p>Explore our vast catalog of thousands of titles spanning every imaginable genre. From bestsellers to timeless classics, and the latest releases, our selection is carefully curated to satisfy every taste</p>
                    </div>
                </div>
            </main>   
        </div>
